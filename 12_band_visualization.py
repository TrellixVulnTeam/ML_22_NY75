...
# min_num, max_num = f.clip(red, 99)
# f.plot_band(red, 'Blues', min_num, max_num, 'B4')
...
file_part = '../datasets/sentinel_2/2020/20200107/IMG_DATA/47PQS_20200107_'
B1  = file_part + 'B01.jp2'
B2  = file_part + 'B02.jp2'
B3  = file_part + 'B03.jp2'
B4  = file_part + 'B04.jp2'
B8  = file_part + 'B08.jp2'
B8A = file_part + 'B8A.jp2'
B11 = file_part + 'B11.jp2'
B12 = file_part + 'B12.jp2'
